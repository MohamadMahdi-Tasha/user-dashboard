    ...
    return (
        <div className={'relative z-10 mb-[40px] lg:block hidden'}>
            <div className={'absolute -z-10 top-[20%] left-[50%] translate-x-[-50%] w-[90%] flex h-[2px]'}>
                <div data-active={(doneStatus === 1 || doneStatus >= 1)} className={'w-[33%] data-[active="true"]:bg-theme data-[active="false"]:bg-gray-300'} />
                <div data-active={(doneStatus === 2 || doneStatus >= 2)} className={'w-[33%] data-[active="true"]:bg-theme data-[active="false"]:bg-gray-300'} />
                <div data-active={(doneStatus === 3 || doneStatus >= 3)} className={'w-[33%] data-[active="true"]:bg-theme data-[active="false"]:bg-gray-300'} />
            </div>
            <div className={'flex items-center gap-[20px] justify-between z-10'}>
                ...
                <ProgressItemComponent isActive={(currentStatus === 4 || currentStatus >= 4)} number={'۴'} title={'بررسی نهایی'} icon={'bi-check-square'} />
            </div>
        </div>
    );
}