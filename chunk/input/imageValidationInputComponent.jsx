    ...
    return (
        <div className={'mb-[35px]'}>
            ...
            <div className={'flex gap-[10px]'}>
                ...
                <button type={'button'} className={'w-[90px] flex justify-center items-center rounded-[10px] duration-500 transition-all hover:bg-darkBlue/30'}><span className={'bi bi-arrow-repeat'} /></button>
            </div>
        </div>
    );
}